 ...
 */
define('vendors/TouchSlide_gm.js',function(require,exports,module){
var TouchSlide = function(a){
	...
	var switchLoadN = opts.switchLoadN;
	...
	var switchLoadNFun = function() {
		if(switchLoadN > 0) {
			...
			for(var index = start; index < switchLoadN; index++) {
				var img = conBox.children[index].getElementsByTagName("img");
				for ( var i=0; i<img.length ; i++ )
				{
					if ( img[i].getAttribute(sLoad) ){
						img[i].setAttribute("src", img[i].getAttribute(sLoad) );
