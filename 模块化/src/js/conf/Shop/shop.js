...
define('conf/Shop/shop.js', function (require, exports, module) {
    ...
    function bindEvents(){
        ...
        $('#viewShopBtn').on('click',function(){
            ...
            //     code: 'B000W002',
            //     name: '查看店铺',
            //     btn_type: base64.encode(oShopTopArr[0])
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('B000W002'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'查看店铺',user_id: params.userid,url:params.url,cook_id:params.cookid,btn_type:oShopTopArr[0]}
                ))
            });
        });
        ...
        $('#productManageBtn').on('click',function(){
            ...
            //     code: 'P000W004',
            //     name: '商品管理',
            //     type: base64.encode(oShopArr[0])
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('P000W004'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'商品管理',user_id: params.userid,url:params.url,cook_id:params.cookid,type:oShopArr[0]}
                ))
            });
        ...
        $('#copyLinkBtn').on('click',function(){
            ...
            //     code: 'B000W002',
            //     name: '复制链接',
            //     btn_type: base64.encode(oShopTopArr[1])
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('B000W002'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'复制链接',user_id: params.userid,url:params.url,cook_id:params.cookid,btn_type:oShopTopArr[1]}
                ))
            });
         });
        //分享店铺
         $('#shareShopBtn').on('click',function(){
            ...
            //     code: 'B000W002',
            //     name: '分享店铺',
            //    btn_type: base64.encode(oShopTopArr[2])
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('B000W002'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'分享店铺',user_id: params.userid,url:params.url,cook_id:params.cookid,btn_type:oShopTopArr[2]}
                ))
            });
         });
        ...
        $('#orderManageBtn').on('click',function(){
            ...
            //     code: 'P000W004',
            //     name: '订单管理',
            //     type: base64.encode(oShopArr[1])
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('P000W004'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'订单管理',user_id: params.userid,url:params.url,cook_id:params.cookid,type:oShopArr[1]}
                ))
            });    
        });
        //店铺设置
        $('#shopConfigBtn').on('click',function(){
            ...
            //     code: 'P000W004',
            //     name: '店铺设置',
            //     type: base64.encode(oShopArr[3])
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('P000W004'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'店铺设置',user_id: params.userid,url:params.url,cook_id:params.cookid,type:oShopArr[3]}
                ))
            }); 
        });
        ...
        $('a.shopBtn-back3').on('click',function(){
            ...
            //         code: 'P000W004',
            //         name: '数据分析',
            //         type: base64.encode(oShopArr[2])
            //     });
            // });
            AppInterface.call('/common/statistics', {
                code: encodeURIComponent('P000W004'),               
                desc: encodeURIComponent(JSON.stringify(
                    {name:'数据分析',user_id: params.userid,url:params.url,cook_id:params.cookid,type:oShopArr[2]}
                ))
            });
         });    
