define("conf/app-Actcms/Actcms-one.js",function (require , exports , module){
    require('$');
    ...
    function toBpsendUrl(str,bps,desc){
        str.click(function(){
            ...
            BP.send({event_id:bps,oImgPic:oImgPic,oUrlPic:oUrlPic,desc:desc});
        });
    }
    toBpsendUrl($('.oSection9 a'),'hd00A000','活动位');
    toBpsendUrl($('.oSection0 a'),'Mhd0A000','H5-模块1');
    // 加载更多
    var metaId = '11348';
