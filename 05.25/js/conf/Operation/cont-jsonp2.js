define("conf/Operation/cont-jsonp2",function(require){
...
$(function(){
	...
	if(window.location.host == 'h5.dev.gomeplus.com'){
		...
		obj.s10 = 123;
		otHost(obj);
		var oHostId = 'metaIds=72247,22185,67936,53421,53612,73984,37551,46125,27588,34365,123'; // 测试环境
		s5 = 73984,s6 = 37551,s7 = 46125,s8 =27588;
	} else if(window.location.host == 'h5-pre.gomeplus.com'){
		obj.s10 = 12;
		otHost(obj);
		var oHostId = 'metaIds=72247,22185,67936,53421,53612,73984,37551,46125,27588,34365,12';//预生产
		s5 = 73984,s6 = 37551,s7 = 46125,s8 =27588;
	}else if(window.location.host == 'h5.gomeplus.com'){
		otHost(obj);
		var oHostId = 'metaIds=72247,22185,67936,53421,53612,73984,37551,46125,27588,34365,43'; //生产环境
		s5 = 73984,s6 = 37551,s7 = 46125,s8 =27588;
	}
		function otHost(obj){
			// 测试环境
		...
		var sectionMap = {
			...
			section10:function(data){
				...
				for(var i=0;i<oSectionShare.length;i++){
					if(oSectionShare[i].activityLink.match("operation/indexsec")){	
